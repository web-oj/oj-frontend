export type Language = 'javascript' | 'typescript' | 'html' | 'json' | 'xml' | 'markdown' | 'plaintext' | 'css' | 'scss' | 'less' | 'python' | 'java' | 'csharp' | 'php' | 'ruby' | 'go' | 'swift' | 'kotlin' | 'rust' | 'dart' | 'yaml' | 'sql' | 'shell' | 'powershell' | 'dockerfile';
